...
const Calendar = () => {
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 min-h-[500px] flex flex-col items-center justify-center p-8 text-center">
      ...
      <h2 className="text-2xl font-bold text-slate-800 mb-2">Platform Calendar</h2>
      <p className="text-slate-500 max-w-md mx-auto">A unified calendar showing all scheduled sessions and platform events.</p>
